...
import { CartWidget, ImagePreview } from "../components";
const DropDown = lazy(() => import("./../components/Collections/Drop"));
const ProductCard = lazy(() =>
  import("./../components/Collections/ProductCard")
);
  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center w-full py-8">
        <motion.article
          className="w-[95%] grid md:grid-cols-2 gap-5"
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.div
            ...
            className="relative flex items-center justify-center py-5 bg-white border cursor-pointer border-black/10 group h-fit"
          >
          ...
          >
            ...
            >
              ...
              <motion.h1
                ...
                className="text-3xl tracking-wider uppercase lg:text-4xl font-extralight text-black/80"
              >
                {Data.name}
              </motion.h1>
              <motion.p
              ...
              <motion.div
                ...
                className="w-fit border border-black/20 h-[50px] flex items-center"
              >
                {Data.stock == 0 ? (
                ...
                >
                  ...
                  >
                    <DropDown
                      ...
                      des={
                        "Free delivery is available on all orders within the U.S."
                      }
                    />
                  </motion.div>
                  <motion.div
          ...
          fallback={
            <>
              ...
              <section className="w-[98.5%] grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-2 z-[9]">
                {Filter.map(({ id }) => (
                  <Skeleton key={id} height="350px" baseColor="#B0B0B0" />
                ))}
              </section>
            </>
          }
        >
          ...
          <motion.section
            ...
            className="w-[98.5%] grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-2 z-[9]"
          >
